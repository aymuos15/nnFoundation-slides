...
\midrule
\sw{unet}nnU-Net Default & not stated (cites original nnU-Net) & random \\
...
nnU-Net ResEnc-L baseline & \textcolor{cnn}{as CNN scratch} \\
Scale / modality ablations & \textcolor{unet}{no} \\
nnU-Net baseline in low-data experiments & \textcolor{unet}{no} \\
Architecture of ``nnU-Net Default'' & \textcolor{unet}{no} \\
\bottomrule
\end{tabular}
\end{frame}
% ------------------------------------------------------------------
...
MSD Pancreas 63.7 & ``ResEnc-L from scratch'' & Default and scratch both (F13) \\
\bottomrule
\end{tabular}}
\end{frame}
